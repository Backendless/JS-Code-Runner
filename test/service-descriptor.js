...
<namespaces>
  <namespace name="services" fullname="services">
    <service name="ShoppingCartService" description="ShoppingCartService" fullname="services.ShoppingCartService" namespace="services">
      <method name="addItem" type="void" nativetype="void" fulltype="void" javatype="void" description="" operationName="addItem" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}">
      ...
      <method name="addItems" type="void" nativetype="void" fulltype="void" javatype="void" description="addItems description" operationName="addItems" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}">
        <arg name="cartName" type="String" nativetype="String" fulltype="String" javatype="java.lang.String" required="true" description="cart name description"/>
      ...
      <method name="purchase" type="Order" nativetype="services.Order" fulltype="services.Order" javatype="services.Order" description="" operationName="purchase" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}">
...
<namespaces>
  <namespace name="services" fullname="services">
    <service name="PetStore" description="Simple Pet Store demonstrating explicit http routes for service methods" fullname="services.PetStore" namespace="services">
      <method name="getAll" type="Pet" nativetype="services.Pet" fulltype="services.Pet" javatype="services.Pet" description="List all pets" operationName="getAll" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}" method="GET" path="/">
      </method>
      <method name="create" type="Pet" nativetype="services.Pet" fulltype="services.Pet" javatype="services.Pet" description="Make a new pet" operationName="create" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}" method="POST" path="/">
      ...
      <method name="save" type="Pet" nativetype="services.Pet" fulltype="services.Pet" javatype="services.Pet" description="Save pet" operationName="save" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}" method="PUT" path="/">
      ...
      <method name="getPet" type="Pet" nativetype="services.Pet" fulltype="services.Pet" javatype="services.Pet" description="Sends the pet with pet Id" operationName="getPet" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}" method="GET" path="/{petId}">
      </method>
      <method name="deletePet" type="PetDeleteResponse" nativetype="services.PetDeleteResponse" fulltype="services.PetDeleteResponse" javatype="services.PetDeleteResponse" description="Delete the pet by pet Id" operationName="deletePet" registerAs="" category="" appearanceIcon="" appearanceColor="" metaInfo="{&quot;args&quot;:{},&quot;sampleResult&quot;:null,&quot;sampleResultLoader&quot;:null}" method="DELETE" path="/{petId}">
      </method>
    </service>
