...
/**
 * Enriches service method node by adding 'method', 'route', 'description', 'operationName', 'argsMappings'
 * 'registerAsAutomationAction' and 'systemNonBillableRequest' attributes.
...
function enrichMethodNode(methodNode, method) {
  ...
  methodNode.registerAsAutomationAction = method.tags.hasOwnProperty('registerasautomationaction')
  ...
  methodNode.argsMappings = method.tags.argsmappings || ''

  if (methodNode.registerAsAutomationAction) {
    methodNode.actionBlockIcon = method.tags.actionblockicon || ''
    methodNode.actionBlockColorStart = method.tags.actionblockcolorstart || ''
    methodNode.actionBlockColorEnd = method.tags.actionblockcolorend || ''
  }
